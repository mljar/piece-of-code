...
import { PutIcon } from "../../icons/httpPut";
...
const DOCS_URL = "python-http-put-request";
...
export const PutRequest: React.FC<IRecipeProps> = ({
  setCode,
  setPackages,
  metadata,
  setMetadata,
...
export const PutRequestRecipe: IRecipe = {
  name: "Put request",
  longName: "Put request",
  parentName: "http-requests",
  // len: 222
  description: "Send HTTP Put request to the URL of your choosing, pass URL parameters and data body as string or JSON, set timeout, authenticate with many different auth options, display the response, even pretty print the JSON response.",
  shortDescription: "Send HTTP Put request to the URL of your choosing, pass URL parameters and data body as string or JSON, set timeout, authenticate with many different auth options, display the response, even pretty print the JSON response.",
  codeExplanation: `
...
`,
  ...
  docsUrl: DOCS_URL,
  tags: ["http", "requests", "put"],
  defaultVariables: [],
};
export default PutRequestRecipe;
