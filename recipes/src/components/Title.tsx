...
export const Title: React.FC<TitleProps> = ({
  ...
  const cl =
    "poc-text-lg poc-font-medium poc-text-gray-900 dark:poc-text-white poc-pb-1";
  return (
    <div>
      <h2 className={cl}>
        {!hideTitle && (
        ...
        {setAdvanced && (
          <div className="poc-inline poc-items-center poc-px-2 poc-pt-1 poc-absolute poc-right-4">
            <label
