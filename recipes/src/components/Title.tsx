          ...
          >
            ...
            <div
              className="poc-w-9 poc-h-5 poc-bg-gray-200 peer-focus:poc-outline-none peer-focus:poc-ring-4 
                        ...
                        rtl:peer-checked:after:poc--translate-x-full 
                        peer-checked:after:poc-border-white after:content-[''] 
                        after:poc-absolute after:top-[2px] after:start-[2px] after:poc-bg-white after:poc-border-gray-300 after:poc-border after:poc-rounded-full after:poc-h-4 after:poc-w-4 after:poc-transition-all dark:poc-border-gray-600 peer-checked:poc-bg-blue-600"
            ></div>
            <span className="ms-1 poc-text-xs poc-font-normal poc-text-gray-900 dark:poc-text-gray-300">
              Advanced
            </span>
          </label>
        </div>
